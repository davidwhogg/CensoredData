...
\begin{figure}
  ...
  \end{center}
  \caption{An example of why this project is necessary.  The points are... \hogg{this should be a figure showing heavily censored data and a traditional fit to them, folded AND UNFOLDED, showing that the traditional fit is way wrong.}\label{fig:badfit}}
\end{figure}
